...
HD_PWD='C:/Users/Yarib/poxi/poxi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log poxi_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source poxi_design_wrapper.tcl -notrace
