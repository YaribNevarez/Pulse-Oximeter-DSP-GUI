...
HD_PWD='C:/Users/Yarib/poxi/poxi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log poxi_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source poxi_design_wrapper.tcl
