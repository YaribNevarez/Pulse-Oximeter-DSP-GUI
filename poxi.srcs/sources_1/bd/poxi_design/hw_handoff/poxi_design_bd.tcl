...
################################################################
# This is a generated script based on design: poxi_design
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set adccs [ create_bd_port -dir O adccs ]
  set daccs [ create_bd_port -dir O daccs ]
  set iron [ create_bd_port -dir O iron ]
  set pgacs [ create_bd_port -dir O pgacs ]
  set psclk [ create_bd_port -dir O psclk ]
  set psmiso [ create_bd_port -dir I psmiso ]
  set psmosi [ create_bd_port -dir O psmosi ]
  set rdon [ create_bd_port -dir O rdon ]
  set tft_cs [ create_bd_port -dir O tft_cs ]
  set tft_dc [ create_bd_port -dir O tft_dc ]
  set tft_mosi [ create_bd_port -dir O tft_mosi ]
  set tft_r [ create_bd_port -dir O tft_r ]
  set tft_sck [ create_bd_port -dir O tft_sck ]
  set zLED [ create_bd_port -dir O -from 3 -to 0 zLED ]
  set zPushB [ create_bd_port -dir I -from 3 -to 0 zPushB ]
  set zSwitch [ create_bd_port -dir I -from 3 -to 0 zSwitch ]
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins POXI_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins TFT_SPI_DISPLAY_240x320_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net POXI_0_adccs [get_bd_ports adccs] [get_bd_pins POXI_0/adccs]
  connect_bd_net -net POXI_0_daccs [get_bd_ports daccs] [get_bd_pins POXI_0/daccs]
  connect_bd_net -net POXI_0_iron [get_bd_ports iron] [get_bd_pins POXI_0/iron]
  connect_bd_net -net POXI_0_pgacs [get_bd_ports pgacs] [get_bd_pins POXI_0/pgacs]
  connect_bd_net -net POXI_0_psclk [get_bd_ports psclk] [get_bd_pins POXI_0/psclk]
  connect_bd_net -net POXI_0_psmosi [get_bd_ports psmosi] [get_bd_pins POXI_0/psmosi]
  connect_bd_net -net POXI_0_rdon [get_bd_ports rdon] [get_bd_pins POXI_0/rdon]
  connect_bd_net -net POXI_0_zLED [get_bd_ports zLED] [get_bd_pins POXI_0/zLED]
  connect_bd_net -net TFT_SPI_DISPLAY_240x320_0_tft_cs [get_bd_ports tft_cs] [get_bd_pins TFT_SPI_DISPLAY_240x320_0/tft_cs]
  connect_bd_net -net TFT_SPI_DISPLAY_240x320_0_tft_dc [get_bd_ports tft_dc] [get_bd_pins TFT_SPI_DISPLAY_240x320_0/tft_dc]
  connect_bd_net -net TFT_SPI_DISPLAY_240x320_0_tft_mosi [get_bd_ports tft_mosi] [get_bd_pins TFT_SPI_DISPLAY_240x320_0/tft_mosi]
  connect_bd_net -net TFT_SPI_DISPLAY_240x320_0_tft_r [get_bd_ports tft_r] [get_bd_pins TFT_SPI_DISPLAY_240x320_0/tft_r]
  connect_bd_net -net TFT_SPI_DISPLAY_240x320_0_tft_sck [get_bd_ports tft_sck] [get_bd_pins TFT_SPI_DISPLAY_240x320_0/tft_sck]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins POXI_0/s00_axi_aclk] [get_bd_pins TFT_SPI_DISPLAY_240x320_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net psmiso_1 [get_bd_ports psmiso] [get_bd_pins POXI_0/psmiso]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins POXI_0/s00_axi_aresetn] [get_bd_pins TFT_SPI_DISPLAY_240x320_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net zPushB_1 [get_bd_ports zPushB] [get_bd_pins POXI_0/zPushB]
  connect_bd_net -net zSwitch_1 [get_bd_ports zSwitch] [get_bd_pins POXI_0/zSwitch]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs POXI_0/S00_AXI/S00_AXI_reg] SEG_POXI_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs TFT_SPI_DISPLAY_240x320_0/S00_AXI/S00_AXI_reg] SEG_TFT_SPI_DISPLAY_240x320_0_S00_AXI_reg
...
preplace port psmosi -pg 1 -y 480 -defaultsOSRD
preplace port tft_mosi -pg 1 -y 180 -defaultsOSRD
preplace port tft_r -pg 1 -y 240 -defaultsOSRD
preplace port pgacs -pg 1 -y 440 -defaultsOSRD
preplace port daccs -pg 1 -y 460 -defaultsOSRD
preplace port tft_sck -pg 1 -y 200 -defaultsOSRD
preplace port psclk -pg 1 -y 360 -defaultsOSRD
preplace port iron -pg 1 -y 420 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace port rdon -pg 1 -y 400 -defaultsOSRD
preplace port psmiso -pg 1 -y 420 -defaultsOSRD
preplace port tft_cs -pg 1 -y 260 -defaultsOSRD
preplace port tft_dc -pg 1 -y 220 -defaultsOSRD
preplace port adccs -pg 1 -y 380 -defaultsOSRD
preplace portBus zLED -pg 1 -y 340 -defaultsOSRD
preplace portBus zPushB -pg 1 -y 400 -defaultsOSRD
preplace portBus zSwitch -pg 1 -y 380 -defaultsOSRD
preplace inst POXI_0 -pg 1 -lvl 3 -y 410 -defaultsOSRD
preplace inst TFT_SPI_DISPLAY_240x320_0 -pg 1 -lvl 3 -y 220 -defaultsOSRD
...
preplace netloc POXI_0_adccs 1 3 1 NJ
preplace netloc POXI_0_rdon 1 3 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 420
preplace netloc TFT_SPI_DISPLAY_240x320_0_tft_sck 1 3 1 NJ
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 420 460 720
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 0 200 390
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 690
preplace netloc POXI_0_psmosi 1 3 1 NJ
preplace netloc POXI_0_pgacs 1 3 1 NJ
preplace netloc zPushB_1 1 0 3 NJ 400 NJ 400 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 60 NJ 60 NJ
preplace netloc POXI_0_psclk 1 3 1 NJ
preplace netloc TFT_SPI_DISPLAY_240x320_0_tft_r 1 3 1 NJ
preplace netloc psmiso_1 1 0 3 NJ 420 NJ 420 NJ
preplace netloc POXI_0_zLED 1 3 1 NJ
preplace netloc zSwitch_1 1 0 3 NJ 380 NJ 380 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -10 440 400 440 710
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 700
preplace netloc TFT_SPI_DISPLAY_240x320_0_tft_cs 1 3 1 NJ
preplace netloc POXI_0_daccs 1 3 1 NJ
preplace netloc POXI_0_iron 1 3 1 NJ
preplace netloc TFT_SPI_DISPLAY_240x320_0_tft_mosi 1 3 1 NJ
preplace netloc TFT_SPI_DISPLAY_240x320_0_tft_dc 1 3 1 NJ
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 410
levelinfo -pg 1 -30 210 560 830 960 -top 0 -bot 530
",
}
