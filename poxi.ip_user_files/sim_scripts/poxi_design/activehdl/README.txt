...
#
# Generated by export_simulation on Mon Jan 09 11:43:31 +0100 2017
#
################################################################################
...
switch to the './poxi_design.sh' script.

./poxi_design.sh -reset_run
...
./poxi_design.sh -noclean_files

For more information on the script, please type './poxi_design.sh -help'.
